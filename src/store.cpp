...
namespace mini {
	...
	resource_store::resource_store () {
		...
		m_bspline_surf_shader = m_load_shader ("shaders/vs_pass_uv.glsl", "shaders/fs_solidcolor.glsl",
			"shaders/tcs_bezier_isolines.glsl", "shaders/tes_bspline_isolines.glsl", "shaders/gs_lines.glsl");

		m_bspline_surf_solid_shader = m_load_shader ("shaders/vs_pass_uv.glsl", "shaders/fs_solidcolor.glsl",
